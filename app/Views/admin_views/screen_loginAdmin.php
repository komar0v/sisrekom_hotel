            ...
            <div class="auth-box bg-dark">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="<?php echo base_url('/asset_web/home_assets') ?>/img/logo_app.png" width="200" height="80" /></span>
                    </div>
                    <!-- Form -->
                    <?= form_open('Administrasi/validasi_login') ?>
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input autocomplete="off" type="text" class="form-control form-control-lg" name="e" placeholder="E-Mail" aria-label="E-Mail" aria-describedby="basic-addon1" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-warning text-white" id="basic-addon2"><i class="fas fa-lock"></i></span>
                                    </div>
                                    <input type="password" class="form-control form-control-lg" name="p" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1" required="">
                                </div>
                            </div>
                        </div>
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-success float-right" type="submit"><i class="fas fa-key"></i>  Login</button>
                                    </div>
                                </div>
                            </div>
                        </div>
