...
class Loved_MDL extends Model
{
    ...
    public function delete_loved_hotelByUser($id_user){
        return $this->db->table('tbl_loved')
        ->join('tbl_data_hotel','tbl_data_hotel.id_hotel=tbl_loved.id_hotel')
        ->where('id_user_loved', $id_user)->delete();
    }

    public function get_banyaknyaHotelLovedbyUser($id_user){
        return $this->db->table('tbl_loved')
        ->join('tbl_data_hotel','tbl_data_hotel.id_hotel=tbl_loved.id_hotel')
        ->where('id_user_loved', $id_user)->countAllResults();
    }
